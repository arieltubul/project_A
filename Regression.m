function [coefficients, totalLength, stepLength] = Regression(features)
global En_linerReg
...
coefficients = regress(prediction, data);
...
stepLength = coefficients(1) + coefficients(2)*(std_tot) + coefficients(3)*(p2p_tot);
